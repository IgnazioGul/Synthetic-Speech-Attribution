...
def preprocess_item(audio, sr: int, model_name: Literal['attVgg16', "passt"],
    ...
    spec_img = spec
    if model_name == "attVgg16":
        spec_img = cv2.resize(spec_img, (224, 224))
    elif model_name == "passt" and extract_manual_spec:
    ...
    if model_name == "passt" or should_return_waveform:
        return audio, spec
    else:
