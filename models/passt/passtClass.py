...
from models.passt.vit_helpers import DropPath, trunc_normal_, build_model_with_cfg
...
class PaSST(nn.Module):
    ...
    def __init__(self, u_patchout=0, s_patchout_t=0, s_patchout_f=0, img_size=(128, 250), patch_size=16, stride=16,
